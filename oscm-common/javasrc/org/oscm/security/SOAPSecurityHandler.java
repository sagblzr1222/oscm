    ...
    public boolean handleMessage(final SOAPMessageContext msgCtx) {
        ...
        if (outInd.booleanValue()) {
            ...
            try {
                ...
                String resName = responseElement.getLocalName();
                if (resName != null && !resName.endsWith("Response")) {
                    resName = resName + "Response";
                    responseElement.setElementQName(
                            new QName(responseElement.getNamespaceURI(),
                                    resName, responseElement.getPrefix()));
                }
